...
# 04 - REST API
The method in which data is communicated is through routes, each route is listend for by Socket.io and when a route is called, the designated function is used. Below I have created a table listing all routes used within the application and their
